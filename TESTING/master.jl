...
z22 = generateCPPDataset(100, 2, 1.0, 3.0, [1.2, 1.8], [-2.2, 3], 4.0)
z33 = generateCPPDataset(100, 2, 1.0, 3.0, [1.2, 1.8], [-2.2, 3], 4.0)
# println(z)
saveCPPDataset("/home/wikash/tmp/", 100, z, 1)
saveCPPDataset("/home/wikash/tmp/", 100, z22, 2)
saveCPPDataset("/home/wikash/tmp/", 100, z33, 2, 1.0, 3.0, [1.2, 1.8], [-2.2, 3], 4.0)

z1 = loadCPPDataset("/home/wikash/tmp/", 100, 1)
z2 = loadCPPDataset("/home/wikash/tmp/", 100, 2)
z3 = loadCPPDataset("/home/wikash/tmp/", 100, 2, 1.0, 3.0, [1.2, 1.8], [-2.2, 3], 4.0)
z4 = loadCPPDataset("/home/wikash/tmp/", 100, 1, 12)
z5 = loadCPPDataset("/home/wikash/tmp/", 100, 1, 13)
z6 = loadCPPDataset("/home/wikash/tmp/", 100, 2, 1.0, 3.0, [1.2, 1.8], [-2.2, 3], 4.0, 17)
println(z1[1])
println(z4[1])
println(z5[1])
println(z3[1])
